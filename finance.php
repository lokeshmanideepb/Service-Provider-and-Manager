                ...
                <div style="width: 15%;margin-left:-2em;margin-top: 3em;float: left;font-size: 18px;">
                    <aside class="asideclass">
                        <ul style="list-style-type: none">
                            ...
                            <li><input type="radio" class="common_selector service" value="Plumber" name="type"> Plumber
                            </li>
                            ...
                            <li><input type="radio" class="common_selector service" value="Carpenter" name="type">
                                Carpenter</li>
                            <li><input type="radio" class="common_selector service" value="AC & Refrigerator"
                                    name="type"> AC &
                                Refrigerator</li>
                        ...
                        <ul style="list-style-type: none">
                            ...
                            <li><input type="radio" class="common_selector city" name="city" value="Hyderabad">
                                Hyderabad</li>
                            <li><input type="radio" class="common_selector city" name="city" value="Banglore"> Banglore
                            </li>
                        </ul>
                    </aside>
                </div>
